...
Public Interface ILocation
    ...
    Function CreateCharacter(characterType As String, name As String, pronouns As String, flavor As String, Optional initialize As CharacterInitializer = Nothing) As ICharacter
